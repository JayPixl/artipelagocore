...
- `artipelago:on_pokemon_level_up`
  Fires when a player's Pokemon levels up.

- `artipelago:on_ride_pokemon_interval`
  Fires while a player is actively traveling on a ridden Pokemon. This currently triggers every 128 blocks ridden with a minimum 5-second spacing.
